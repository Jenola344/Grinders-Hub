        ...
        <>
            ...
            <AnimatePresence>
                {isScrolled && (
                    ...
                    >
                        <Container className="flex items-center justify-between pl-20">
                            <h1 className="text-xl md:text-2xl text-white font-serif tracking-tight cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
                                The Grinders <span className="text-primary italic">Hub</span>
                            </h1>
                            <div className="flex items-center gap-6">
                                <span className="hidden lg:inline text-sm text-text-secondary font-medium italic">
                                    Enrollment closing soon...
                                </span>
                                <Button
                                    className="px-8 py-3 text-sm md:text-base h-auto"
